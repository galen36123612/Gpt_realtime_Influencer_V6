...
const SHEN_MEDIA_TOPIC_PATTERN =
  /HEART|蔡英文|陪同登記|參選登記|選票號次|抽號次|船舵|舵輪|洋流|交換學生|獎學金|利益迴避|利益衝突|兒虐|兒童保護|交互詰問|市長辯論|2500億|今周刊|POP最正點|POPRadio|林書煒|王偉忠|偉忠哥|欸我說到哪裡了|老市民發問|市長你給我聽好了|市民心聲|市民參與企劃|社福政策|臨時托老券|腸病毒疫苗|女性安全審計|歷任市長|五分埔|廣慈|奉天宮|台北隊|聯合競選|聯合配票|健身小巴|超級運動中心|國際足球場|內湖交通|內湖淹水|老屋延壽|行動服務團|北士科|台北研究院|無菸城市|訪日|日本後援會|旅日青年|城市外交|統戰|太弱|勤走基層/i;
